...
namespace Drupal\graphql_voyager\Routing;
...
class VoyagerRoutes extends RouteSubscriberBase {
  ...
  protected function alterRoutes(RouteCollection $collection) {
    ...
    foreach ($this->schemaManager->getDefinitions() as $key => $definition) {
      $routes->add("graphql_voyager.voyager.$key", new Route("{$definition['path']}/voyager", [
        'schema' => $key,
        '_controller' => '\Drupal\graphql_voyager\Controller\VoyagerController::viewVoyager',
