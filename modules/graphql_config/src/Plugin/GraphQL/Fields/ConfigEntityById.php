 ...
 *
 * @GraphQLField(
 *   id = "config_entity_by_id",
 *   secure = true,
 *   name = "configEntityById",
 *   nullable = true,
 *   multi = false,
 *   weight = -1,
 *   arguments = {
 *     "id" = "String"
 *   },
 *   deriver = "\Drupal\graphql_config\Plugin\Deriver\EntityByIdDeriver"
 * )
 */
class ConfigEntityById extends FieldPluginBase implements ContainerFactoryPluginInterface {
