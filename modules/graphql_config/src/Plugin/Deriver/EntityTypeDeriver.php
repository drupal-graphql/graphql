...
class EntityTypeDeriver extends DeriverBase implements ContainerDeriverInterface {
   ...
   * @param \Drupal\graphql_config\ConfigEntitySchemaConfig $schemaConfig
   *   The schema configuration service.
   */
  public function __construct(EntityTypeManagerInterface $entityTypeManager, ConfigEntitySchemaConfig $schemaConfig) {
