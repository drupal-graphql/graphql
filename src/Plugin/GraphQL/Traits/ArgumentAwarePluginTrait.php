...
trait ArgumentAwarePluginTrait {
   ...
   */
  protected function buildArguments(PluggableSchemaManagerInterface $schemaManager) {
   ...
   *   The type object.
   */
  protected function buildArgumentType(PluggableSchemaManagerInterface $schemaManager, $argument) {
